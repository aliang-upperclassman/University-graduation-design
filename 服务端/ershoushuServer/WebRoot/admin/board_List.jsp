...
<html>
	...
	<body>
		<table width="98%" border="0" align="center" cellpadding="0"
			...
			<form id="form" action="BoardServlet?action=add" method="post">
		<table style="text-align: center" align="center">
			...
			<tr>
				<td>
					...
					<input type="button" value="清空留言" onclick="javascript:document.getElementById('content').value=''" />
				</td>
			</tr>
		</table>
		</form>
			...
			<tr>
				...
				<td align="right" colspan="2"
					...
					<div
						...
						<!--<a href="">回复</a>&nbsp;&nbsp;
						-->
						<c:if   test = "${sessionScope.logintype==1}" >
						<a href="BoardServlet?action=delete&id=${list.ID}"> 删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
						</c:if>
					</div>
				</td>
			</tr>
