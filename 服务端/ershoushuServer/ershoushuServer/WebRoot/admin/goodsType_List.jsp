	...
	<body style="text-align: center" onload="noteAlert()">
		...
		<table class="table">
			<thead>
				...
				<c:forEach var="list" items="${goodsTypeList}" varStatus="status">
					<tr>
						<td>
							${status.count}
						</td>
						...
						<td>
							<a href="GoodsTypeServlet?action=edit&id=${list.ID}">修改</a>&nbsp;|&nbsp;
							<a href="GoodsTypeServlet?action=delete&id=${list.ID}">删除</a>
						</td>
					</tr>
				</c:forEach>
			</thead>
